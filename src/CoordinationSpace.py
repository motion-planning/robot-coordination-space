...
from guiqwt.tests.polygons import YMAX
...
# Find the neighbors of a point# def findNeighbors(x, y, z, radius):
#     return [[[cSpace[i][j][k]
...
def findNeighbors(point):
    ...
    return map(list, list(itertools.product(*combinations)))
